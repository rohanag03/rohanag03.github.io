...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Rohan Nag";
...
var typed = new Typed(".typing-text", {
    strings: ["Android Development", "Data Science", "Machine Learning", "Software Development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
document.getElementById('contact-form').addEventListener('submit', function(event) {
    ...
    emailjs.init("M3dwDTXsmBoavvKOT"); // Your EmailJS User ID

    emailjs.sendForm('service_wv922c3', 'template_shz3u4c', this)
        .then(function() {
